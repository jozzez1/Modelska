...
kjer velja $p_\zeta = \dot{\zeta}$ in $p_\psi = \dot{\psi}$. Odvoda gibalnih koli\v cin pa dobimo lahko
iz ena\v cb~\eqref{polarne} in hitro ugotovimo
\begin{align*}
    \dot{p}_\zeta &= \dot{\p}_3 \cdot \ee_\zeta + \zeta p_\psi^2, \\
    \dot{p}_\psi  &= \dot{\p}_3 \cdot \ee_\psi/\zeta^2 - 2 \frac{p_\psi p_\zeta}{\zeta}
\end{align*}
kjer upo\v stevamo \v se
\begin{align*}
...
\begin{align}
    ...
    \zeta\bigg[\bigg(\frac{M_1}{|\r_{31}|^{3/2}} - \frac{M_2}{|\r_{32}|^{3/2}}\bigg) - p_\psi^2\bigg] \\
    \dot{p}_\psi &= \frac{1}{\zeta}\bigg[\frac{\rho}{2}\bigg(\frac{1}{|\r_{31}|^{3/2}} +
        \frac{1}{|\r_{32}|^{3/2}}\bigg)\sin(\varphi - \psi) - 2p_\psi p_\zeta\bigg]
\end{align}
